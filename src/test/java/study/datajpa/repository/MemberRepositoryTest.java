...
class MemberRepositoryTest {
    ...
    public void returnType(){
        ...
        Optional<Member> optAAA = memberRepository.findOptionalByUsername("AAA");
...
//        em.clear();
    ...
    public void findMemberLazy(){
        ...
        //when
        //select Member 1 -> select Tema N => N + 1
    ...
    @Test
    public void CloseIfProjections(){
        //given
        Team teamA = new Team("teamA");
        em.persist(teamA);
